...
- Tsiatis and Davidian (2004) covers the formulation of the likelihood which depends on the data itselfs and the modeling assumptions
...
- The variances of the eigenscores and $h_g$ can be sampled from using Gibbs sampling
