...
output: 
  xaringan::moon_reader:
    css: ["xaringan-themer.css", "slides4.css"]
    nature:
      navigation:
        scroll: false
...
style_mono_light(
  base_color = "#0C4160",
  white_color = lighten_color("#C3CEDA", .9),
  black_color = "#071330",
  text_color = "#000000",
...
- Henderson et. al. 2000 provides a more general form of the joint model, for which this is a subset of
